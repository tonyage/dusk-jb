package com.tonyage.notification
...
import com.tonyage.ThemeManager.PLUGIN_ID
...
object Notifications {
    ...
    private val notificationGroup = NotificationGroupManager.getInstance().getNotificationGroup("Dusk Theme")

    fun displayUpdateNotification(versionNumber: String) {
        val pluginName =
            getPlugin(PluginId.getId(PLUGIN_ID))?.name ?: "Dusk Theme"
